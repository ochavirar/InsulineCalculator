        ...
        children: [
          Padding(
            ...
            child: Container(
              ...
              width: 145 +
                  36.5 * Provider.of<ReportsProvider>(context).listAvg.length,
              child: BarChart(
                BarChartData(
                  ...
                  barGroups: List.generate(
                      Provider.of<ReportsProvider>(context).listAvg.length,
                      (index) {
                    return BarChartGroupData(
                        x: Provider.of<ReportsProvider>(context).startDate.day +
                            index,
                        barRods: [
                          BarChartRodData(
                              toY: Provider.of<ReportsProvider>(context)
                                  .listAvg[index],
